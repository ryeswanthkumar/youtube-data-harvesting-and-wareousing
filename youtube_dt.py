...
if select == "HOME":
    st.image("youtube_logo.png", width=200)
    st.markdown("---")
    st.write(":blue[Welcome to YouTube Data Harvesting and Warehousing!]")
    st.write(":green[By YESWANTH KUMAR R]")
    st.markdown("---")
    st.write(''':red[YouTube definition]: :violet[YouTube is a video on demand platform that allows
              creators to upload and share video content. It was first launched in 2005
                and acquired by Google in 2006. YouTube is widely considered one of the world
                's most important and profitable websites: It is the second most visited website in the world.]''')
    st.markdown("---")
    st.markdown(":red[ABOUT THIS PAGE:]")  
    ...
    st.subheader(":violet[Extract Data for Specific Channel]")
    ...
    if st.checkbox("Show Extracted Data"):
        ...
        st.subheader(":red[Playlist Details]")
